---
title: "Methods & MetaScience <img src='https://psyteachr.github.io/images/mms_hex.png' align='right' alt='logo' style='width:25%; box-shadow: none; margin-bottom: 0;' />"
---
...
jdf <- mutate(jdf, Location = case_when(
  id == 17750 ~ "[Zoom](https://uofglasgow.zoom.us/j/94098494960)",
  id == 17771 ~ "[Zoom](https://uofglasgow.zoom.us/j/94098494960)",
...
jdf <- mutate(jdf, resources = case_when(
  ...
  grepl("^Coding Club", title, FALSE) ~ "[(materials)](https://psyteachr.github.io/shiny-tutorials/coding_club.html)",
  TRUE ~ resources
))
...
<br><br>
Methods & MetaScience is a journal club and discussion group organized by the School of Psychology & Neuroscience at the [University of Glasgow](https://www.gla.ac.uk). Meetings are every other week on Wednesdays from 14:00 to 15:00 UK time on Zoom. 
...
This page is rendered when Lisa remembers, but is not (yet) dynamic. For a dynamically updated list of talks, please see [the events list](http://www.psy.gla.ac.uk/events/index.php?sub=12).
...
M&Ms is on hiatus for the summer. Please contact Lisa if you're interested in giving a talk or workshop in the autumn!
