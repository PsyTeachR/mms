...
* filter the book table by genre
* create a dynamic filtering input for location

### 4. Visualising Data

2021-11-10 14:00 (Europe/London)

In this fourth session, we will:

* create an interactive plot (maybe a map?) that visualises the form data
...
### 6. Writing Data to a GoogleSheet

2021-12-01 14:00 (Europe/London)

In this sixth session, we will:
