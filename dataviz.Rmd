...
* **Postponed** Tutorial "Riding tables with {gt} and {gtExtras}" ([Nowak, 2021](https://bjnnowak.netlify.app/2021/10/04/r-beautiful-tables-with-gt-and-gtextras/))
* **Postponed** Talk on Data visualisation of high dimensional data.
...
* [RStudio Tables Gallery](https://community.rstudio.com/c/table-gallery/64)
